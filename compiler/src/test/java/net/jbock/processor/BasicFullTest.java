    ...
    void testBasicGenerated() {
        ...
        List<String> expectedParser =
                List.of(
                        ...
                        "    Map<String, Void> optionNames = Map.of();",
                        "    Map<Void, OptionState> optionStates = Map.of();",
                        "    VarargsParameterParser<Void> parser = VarargsParameterParser.create(optionNames, optionStates, 0);",
                        "    try {",
                        "      parser.parse(tokens);",
