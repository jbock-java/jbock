...
public @interface Parameter {
   ...
   *
   * <p>This string must not contain whitespace, or the dash '-' or equals '=' character.
  ...
  /**
   * <p>Short names defome arguments that start with a single dash.</p>
   *
   * <p>This character must not be a dash.</p>
   *
   * <p>A space is special syntax for no short name.</p>
   *
   * @return either space or a character that is a valid short name
   */
